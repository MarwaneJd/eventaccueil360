      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              ...
              <div className="text-2xl font-bold mb-2">
                ...
                <span className="text-green-400">ACCUEIL</span>
                <span className="text-red-500">.</span>
                <span className="text-blue-400">360</span>
              </div>
              <div className="bg-red-600 text-white text-xs px-2 py-1 rounded-sm inline-block">
                CONTACT 07 73 72 10 10
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.instagram.com/eventaccueil360/"
              ...
              <a
                href="https://www.tiktok.com/@eventaccueil.360"
                className="w-10 h-10 bg-gray-900 rounded-full flex items-center justify-center text-white hover:bg-black transition-colors duration-200"
                aria-label="TikTok"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} EVENTACCUEIL360. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
