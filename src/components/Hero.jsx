        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  aria-label="Découvrir nos services d'impression textile"
                >
              >
                Nos services
              </a>
              <a
                ...
                aria-label="Voir notre gamme de produits textiles"
              >
                Voir nos produits
              </a>
            </div>
          ...
          <div className="relative">
            <div className="flex justify-center items-center">
              <img 
                src="/hero-tshirt.png" 
                alt="T-shirt personnalisé Event Accueil 360 - Impression textile haute qualité à Rabat" 
